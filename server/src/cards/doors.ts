...
const monsters: Omit<Card, 'id'>[] = [
  ...
  { type: 'monster', deck: 'door', name: 'Wannabe Vampire', description: 'A poseur with fangs.', level: 8, treasures: 2, levelsAwarded: 2, badStuff: 'Lose 2 levels.', tags: ['undead'] },
  ...
  { type: 'monster', deck: 'door', name: 'Mr. Bones', description: 'Skeleton with attitude.', level: 2, treasures: 1, levelsAwarded: 1, badStuff: 'Lose 1 level.', tags: ['undead'] },
  { type: 'monster', deck: 'door', name: 'Undead Horse', description: 'Should have been put down.', level: 4, treasures: 2, levelsAwarded: 1, badStuff: 'Discard 1 weapon.', tags: ['undead'] },

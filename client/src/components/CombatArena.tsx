  ...
  return (
    <div className="surface-glass p-4">
      ...
      <div className="grid grid-cols-[1fr_auto_1fr] gap-3 mt-3 items-stretch">
        <div className="rounded-xl bg-amber-950/40 p-3 border border-amber-900/30">
          <div className="text-xs opacity-60">{t.playerSide}</div>
          <div className="text-3xl font-bold text-emerald-300 font-display">{combat.playerPower}</div>
        ...
        <div className="rounded-xl bg-amber-950/40 p-3 border border-amber-900/30">
          ...
          <div className="text-3xl font-bold text-red-300 font-display">{combat.monsterPower}</div>
          <div className="h-1.5 rounded-full bg-slate-700 mt-2 overflow-hidden">

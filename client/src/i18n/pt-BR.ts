...
export const ptBR: Translations = {
  ...
  watchBots: 'Assistir bots jogarem',
  replay: 'Replay',
  replayTitle: 'Bots jogando',
  replayPreset: 'Cenário',
  replayGenerate: 'Gerar partida',
  replayPlay: 'Play',
  replayPause: 'Pausar',
  replayPrev: 'Frame anterior',
  replayNext: 'Próximo frame',
  replaySpeed: 'Velocidade',
  replayScrub: 'Linha do tempo',
  replayOutcome: 'Resultado',
  replayEmpty: 'Escolha um cenário e clique em Gerar partida.',
